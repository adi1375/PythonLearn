...
def remove_recognized():
    ...
    data.to_csv("Python_100_days/Day31_Flashcards/data/words_to_learn.csv", index=False)
...
card_front = PhotoImage(file="Python_100_days/Day31_Flashcards/images/card_front.png")
card_back = PhotoImage(file="Python_100_days/Day31_Flashcards/images/card_back.png")
...
# button Wrong
image_dont_recognize = PhotoImage(file="Python_100_days/Day31_Flashcards/images/wrong.png")
...
# button Right
image_recongnize = PhotoImage(file="Python_100_days/Day31_Flashcards/images/right.png")
...
try:
    data = pandas.read_csv("Python_100_days/Day31_Flashcards/data/words_to_learn.csv")
except FileNotFoundError:    
    data = pandas.read_csv("Python_100_days/Day31_Flashcards/data/japeng.csv")
